# -*- coding: utf-8 -*-
"""Deep_Batch_Leakage_from_Gradients.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1_jb5uDAAHFzmNODz1qCCTI2EUO631K_h
"""
...
def save_checkpoint(ckpt_location, exp_context):
    if mode == 'production':
...
def create_plt(save_dir, config, gt_data, dummy_datas, dummy_labels, history, loss, psnrs=None):
    ...
    for p in range(participants):
        for j in range(batch_size):
            ...
            print("Participant {} Dummy label {} is {}.".format(p+1, j+1, torch.argmax(dummy_labels[p][j], dim=-1).item()))
